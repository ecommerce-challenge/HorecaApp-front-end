...
(function($) {
	...
	$.widget( "mobile.datebox", $.mobile.widget, {
		options: {
			...
			lang: {
				'default' : {
					setDateButtonLabel: 'Send order',
					setTimeButtonLabel: 'Set Time',
					setDurationButtonLabel: 'Set Duration',
					calTodayButtonLabel: 'Jump to Today',
					titleDateDialogLabel: 'When would you like to receive the order',
		...
		_create: function() {
			...
			if ( o.useButton === true && o.useInline === false && o.useNewStyle === false ) {
				w.d.open = $('<a href="#" class="ui-input-clear" id="datePickerBtn" title="'+this.__('tooltip')+'">'+this.__('tooltip')+'</a>')
